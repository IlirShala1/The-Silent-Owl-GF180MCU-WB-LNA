...
The provided stacks are able to use with the automatic flows for [openEMS](https://github.com/VolkerMuehlhaus/openems_ihp_sg13g2)
...
The Layers `TPMIM`, `MIM_equiv` and `VMIM` are only dedicated to simulate MIM caps. Their stack is adjusted to simulate MIM caps with 2.0&nbsp;fF/µm².
 ...
 Be aware when you are simulating MIMs to move the MIM-Vias in the layout to a new Layer `1041` as `VMIM` in the stack. Otherwise you would short the MIM cap.  
