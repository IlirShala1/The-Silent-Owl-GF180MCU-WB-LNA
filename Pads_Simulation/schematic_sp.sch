...
\\"im(y_2_2) frequency /\\""
hilight_wave=1}
B 2 2275 -360 2885 -80 {flags=graph
y1=-74
y2=-0.017
ypos1=0
ypos2=2
...
autoload=1
color="4 7"
node="\\"s_2_1 abs() log10() 20 *\\"
\\"s_1_2 abs() log10() 20 *\\""
hilight_wave=0
hcursor2_y=-0.52186627}
...
N 0 -430 0 -300 {lab=#net2
}
N 0 -430 150 -430 {lab=#net2
}
N 0 -240 0 -110 {lab=0
}
N 0 -110 150 -110 {lab=0
}
...
N 650 -630 650 -560 {lab=Vin
}
N 710 -270 740 -270 {lab=#net3}
N 800 -270 830 -270 {lab=#net1}
N 610 -270 650 -270 {lab=#net4}
N 510 -270 550 -270 {lab=P_ASIG5V}
N 380 -270 380 -230 {lab=P_ASIG5V}
N 380 -270 510 -270 {lab=P_ASIG5V}
...
"}
C {lab_wire.sym} 460 -750 0 1 {name=p4 sig_type=std_logic lab=Vin
}
...
C {port_diff.sym} 830 -180 0 1 {name=V1 portnum=1 Z0=50 DCval=0 ACmag=1 ACphase=0 TRANval=""}
C {port_diff.sym} 780 -540 0 1 {name=V2 portnum=3 Z0=50 DCval=0 ACmag=1 ACphase=0 TRANval=""}
C {symbols/diode_nd2ps_06v0.sym} 150 -270 2 0 {name=D0
...
C {symbols/cap_nmos_06v0.sym} 0 -270 0 1 {name=C1
W=15e-6
L=15e-6
model=cap_nmos_06v0
spiceprefix=X
...
C {ind.sym} 770 -270 1 0 {name=L10
m=1
value=L
footprint=1206
device=inductor
...
device=inductor
spice_ignore=short}
C {lab_wire.sym} 620 -630 3 0 {name=p7 sig_type=std_logic lab=DVDD
}
C {lab_wire.sym} 650 -560 0 1 {name=p2 sig_type=std_logic lab=Vin
}
C {param.sym} 640 -860 0 0 {name=s1 value="L=3n"}
C {capa.sym} 580 -270 1 0 {name=C2
m=1
value=C
footprint=1206
device="ceramic capacitor"
}
C {param.sym} 640 -890 0 0 {name=s2 value="C=2.5p"}
C {res.sym} 680 -270 1 0 {name=R1
value=200m
footprint=1206
device=resistor
m=1
}
C {port_diff.sym} 380 -200 0 0 {name=V3 portnum=2 Z0=50 DCval=0 ACmag=1 ACphase=0 TRANval=""}
